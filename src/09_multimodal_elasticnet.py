...
X = multi_modal_df.drop(columns=["PatientID", "label", "patientID"])

y = multi_modal_df["label"]
...
plt.savefig("/home/lakshminarayanan_evolution/nsclc-radiogenomics-deep-learning/results/figures/multimodal_elasticnet_confusion.png", dpi=300)
...
plt.tight_layout()
plt.savefig("/home/lakshminarayanan_evolution/nsclc-radiogenomics-deep-learning/results/figures/multimodal_elasticnet_roc.png", dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig("/home/lakshminarayanan_evolution/nsclc-radiogenomics-deep-learning/results/figures/multimodal_elasticnet_top_features.png", dpi=300)
plt.close()
